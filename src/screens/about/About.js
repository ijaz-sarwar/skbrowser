...
function About() {
  return (
    <div style={{ width: '70%', display: 'inline-block', margin: 40, justifyContent: 'flex-start' }}>
      ...
      <p style={{ textAlign: 'start' }}>KPBrowser is the bioinformatics freely available extensible, integrative and user-friendly database which provides access to over 150 gene and protein sequences, various prediction tools to support research activities for <i>K. pneumoniae</i> in life science. <i>K. pneumoniae</i> is one of the most concerning pathogens involved in antibiotic resistance in this day and age, and thus it was a dire need to design a platform where its omics was studied in an indetialed manner to factors that pose a threat on Humans.</p>
      <h2 style={{ textAlign: 'start' }}>Mission</h2>
      <p style={{ textAlign: 'start' }}>Today's biology study is widely acknowledged to require both computer and experimental equipment. The paradigm shift in biology has been strongly influenced by information derived from massive data. Together, <i>in silico</i> and <i>in vitro</i>/<i>in vivo</i> analyses will advance the limits of life sciences. Computer analysis of the rapidly growing nucleotide sequence data is particularly critical for life science researchers. KPBrowser plays a major role in carrying out research on <i>K. pneumonia</i> by providing its complete biological information on the genome, proteome, and metabolome at a single platform. The database could be regarded as a shared human treasure. In view of this, KPBrowser access is provided worldwide.</p>
